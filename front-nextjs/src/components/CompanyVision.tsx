    ...
    <div className="py-[6.25rem]">
      ...
      <div className="mx-auto max-w-5xl space-y-8 py-20 text-center">
        ...
        <div className="space-y-4 text-xl">
          ...
          <div>
            <div>
              나무아이앤씨는 20년간의 데이터 기술 역량을 바탕으로 제조 현장부터
              통합 물류, 고객 접점 및 업무 효율까지,
            </div>
            <div>Digitalization을 통한 차별적 가치를 선도하는 기업입니다.</div>
          </div>
        </div>
      </div>
      <div className="mx-auto max-w-5xl space-y-8 pt-20 text-center">
        <div className="text-3xl font-bold">제공가치</div>
        <Image
        ...
        <div className="space-y-2 text-xl">
          <div>고객에게는 디지털 혁신을 통해 비즈니스 성장을 견인하는 회사</div>
          <div>
