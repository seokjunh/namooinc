    ...
    <div className="py-[6.25rem]">
      <div className="mx-auto max-w-6xl px-4 py-16">
        <div className="mb-10 text-center">
          <h1 className="text-4xl font-semibold text-gray-900">게시판</h1>
        </div>
        ...
        <div className="mt-6 border-t-2 border-gray-200">
          <div className="overflow-x-auto">
            <div className="grid grid-cols-10 gap-4 border-b bg-gray-100 px-4 py-3 text-sm font-medium text-gray-700">
