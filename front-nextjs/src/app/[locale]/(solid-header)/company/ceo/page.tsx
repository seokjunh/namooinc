const page = () => {
  return (
    <div className="py-[6.25rem]">
      ...
      <div className="mx-auto mt-16 max-w-4xl space-y-4 text-lg">
        ...
        <div>
          다양한 경험을 통해 IoT, 스마트 관제, 스마트팩토리의 전문 지식과 기술을
          확보하고 있으며, 최신의 ICT 기술을 활용한 고성능 솔루션을 공급함으로써
        </div>
        <ul className="list-disc list-inside">
          <li>
            데이터 연결: 실시간 데이터 연결을 통해 더욱 정확하고 신속한 의사결정
            지원
          </li>
          <li>
            실시간 인사이트: 디지털 트윈 기술을 활용한 스마트 관제 시스템으로
            효율성 극대화
          </li>
          <li>
            고객 중심: 투명한 소통과 신뢰를 바탕으로 고객 맞춤형 솔루션 제공과
            포괄적 고객 지원
          </li>
        </ul>
        <div>을 약속 드립니다.</div>
        ...
        <div>
          나무아이앤씨는 끊임없는 기술혁신과 최고의 역량으로 고객의 가치 제고에
          기여하고, 임직원의 열정과 고객의 신뢰가 어우러진 최고의 파트너로서
          지속적인 성장을 위해 노력하겠습니다.
        </div>
        <div>나무아이앤씨 임직원 일동</div>
      </div>
    </div>
  );
};
